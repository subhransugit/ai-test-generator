...
def extract_jsx_components(base_path=r"D:\Technical\Tech_Learning\Repos\full-stack-with-react-and-spring-boot\frontend\todo-app\src"):
    """
...
if __name__=="__main__":
    files = extract_jsx_components()
    print(f"[INFO] Total JSX/TSX components found: {len(files)}")
    for f in files:
        print(f)
